...
const music_list = [
    {
        img : 'run/challenge.jpeg',
        name : 'Compress/Repress',
        artist : 'Trent Reznor and Atticus Ross',
        music : 'run music/Compress.mp3'
    },
    {
        img : 'run/challengers.webp',
        name : 'Pull Over',
        artist : 'Trent Reznor and Atticus Ross',
        music : 'run music/PullOver.mp3'
    },
];
